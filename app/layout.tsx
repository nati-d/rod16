...
export const metadata: Metadata = {
	...
	verification: {
		google: "YUgl0nZ6BAGSZXzSgtl8j7EPbQbCi8br8b-AALywXts", //Google Search Console Verification
	...
	return (
		<html lang='en'>
			...
			<body className='antialiased'>
				{/* Google Analytics */}
				<Script
					src="https://www.googletagmanager.com/gtag/js?id=G-V4XYF43MS5"
